...
export const bulletinNotes: BulletinNote[] = [
  {
    ...
    body: "تعزيز الدوريات مطلوب في Vinewood و Del Perro. جميع الوحدات تؤكد الاتصال اللاسلكي قبل 10-8.",
    author: "الإرسال",
  ...
  },
  {
    id: "bb-2",
    title: "تنبيه BOLO",
    body: "Sultan RS أبيض — لوحة جزئية 7K__ — مطلوب في سرقة مسلحة. الاقتراب بحذر.",
  ...
  },
  {
    id: "bb-3",
    title: "تحديث DOJ",
    body: "ملفات Elena Voss و Marcus Webb جاهزة للمراجعة القضائية.",
    author: "وزارة العدل",
...
export const recentReports: ReportSummary[] = [
  { id: "r-101", name: "إيقاف مروري — Legion Square", location: "Legion Square", date: "2026-07-02" },
  { id: "r-102", name: "اعتداء — Mirror Park", location: "Mirror Park Blvd", date: "2026-07-02" },
  { id: "r-103", name: "سطو — Vespucci", location: "Vespucci Canals", date: "2026-07-01" },
];
...
export const dispatchIncidents: DispatchIncident[] = [
  {
    ...
    description: "بلاغات إطلاق نار. عدة متصلين. المشتبه هرب على الأقدام شمالاً.",
    callerName: "مجهول",
  ...
  },
  {
    ...
    description: "شغب في صالة الانتظار. الأمن يطلب مساعدة الشرطة.",
    callerName: "د. Nguyen",
  ...
  },
  {
    ...
    description: "كسر سيارة جاري. Baller أزرق داكن.",
  ...
  },
  {
    ...
    description: "إزعاج من حفلة. الجيران يطلبون تدخل الشرطة.",
    callerName: "Elena Voss",
    callerPhone: "555-0188",
    priority: "low",
    status: "closed",
    mapX: 22,
    mapY: 28,
