"""Desktop shell: settings including Webhooks tab for cross-system integration."""
...
from settings_store import WebhookIntegrationSettings, load_settings, save_settings
from task_manager import update_webhook_settings
...
class MainWindow(QMainWindow):
    ...
    def _build_webhooks_tab(self) -> QWidget:
        ...
        info = QLabel(
            ...
            "<code>code</code> or <code>token</code> (also <code>otp</code>, <code>captcha_token</code>, "
            "<code>solution</code>), that value is typed into the active browser session."
        )
