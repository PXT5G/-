...
export interface IAircraftOffer extends Document {
  offerId: string;
  aircraftId: string;
...
const aircraftOfferSchema = new Schema<IAircraftOffer>(
  {
...
export const AircraftOffer = mongoose.model<IAircraftOffer>('AircraftOffer', aircraftOfferSchema);
