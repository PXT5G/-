...
export interface IVehicleSale extends Document {
  saleId: string;
  vehicleId: string;
  dealerId?: string;
  companyId?: string;
...
const vehicleSaleSchema = new Schema<IVehicleSale>(
  {
...
export const VehicleSale = mongoose.model<IVehicleSale>('VehicleSale', vehicleSaleSchema);
