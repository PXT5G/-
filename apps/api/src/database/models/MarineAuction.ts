...
export interface IMarineAuction extends Document {
  auctionId: string;
  vesselId: string;
  dealerId?: string;
  companyId?: string;
...
const marineAuctionSchema = new Schema<IMarineAuction>(
  {
...
export const MarineAuction = mongoose.model<IMarineAuction>('MarineAuction', marineAuctionSchema);
