...
export interface IVehicleOffer extends Document {
  offerId: string;
  vehicleId: string;
...
const vehicleOfferSchema = new Schema<IVehicleOffer>(
  {
...
export const VehicleOffer = mongoose.model<IVehicleOffer>('VehicleOffer', vehicleOfferSchema);
