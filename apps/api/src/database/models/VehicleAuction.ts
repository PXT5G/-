...
export interface IVehicleAuction extends Document {
  auctionId: string;
  vehicleId: string;
  dealerId?: string;
  companyId?: string;
...
const vehicleAuctionSchema = new Schema<IVehicleAuction>(
  {
...
export const VehicleAuction = mongoose.model<IVehicleAuction>('VehicleAuction', vehicleAuctionSchema);
