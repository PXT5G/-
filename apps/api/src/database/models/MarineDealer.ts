...
export interface IMarineDealer extends Document {
  dealerId: string;
  companyId: string;
  name: string;
  tradeName: string;
...
const marineDealerSchema = new Schema<IMarineDealer>(
  {
    ...
    homeMarinaId: { type: String },
    ...auditSchemaFields,
  },
  { timestamps: true }
);

export const MarineDealer = mongoose.model<IMarineDealer>('MarineDealer', marineDealerSchema);
