...
const deviceProfileSchema = new Schema<IDeviceProfile>(
  {
    ...
    deviceModel: { type: String, default: 'Gulf Phone V1 15 Pro' },
    deviceColor: { type: String, default: 'Gold' },
    serialNumber: { type: String, default: '' },
    deviceUuid: { type: String, default: '' },
    generation: { type: String, default: 'gulf-v1-pro' },
    cpuModel: { type: String, default: 'Gulf A17 Pro Max' },
    gpuModel: { type: String, default: 'Gulf GPU 6-core' },
