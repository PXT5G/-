...
export interface IMarineSale extends Document {
  saleId: string;
  vesselId: string;
  dealerId?: string;
  companyId?: string;
...
const marineSaleSchema = new Schema<IMarineSale>(
  {
...
export const MarineSale = mongoose.model<IMarineSale>('MarineSale', marineSaleSchema);
