...
/** Player must be actively connected — verified session heartbeat stale threshold */
export const DISCORD_VERIFIED_SESSION_STALE_MS = 2 * 60 * 1000;

export const DISCORD_DELIVERY_SKIP_REASONS = {
  DISCORD_NOT_LINKED: 'DISCORD_NOT_LINKED',
  PLAYER_NOT_CONNECTED: 'PLAYER_NOT_CONNECTED',
  NO_VERIFIED_SESSION: 'NO_VERIFIED_SESSION',
  VERIFIED_SESSION_MISMATCH: 'VERIFIED_SESSION_MISMATCH',
  PHONE_ACCESS_LOCKED: 'PHONE_ACCESS_LOCKED',
  NOTIFICATIONS_DISABLED_SESSION: 'NOTIFICATIONS_DISABLED_SESSION',
  NO_ACTIVE_CHARACTER: 'NO_ACTIVE_CHARACTER',
  CHARACTER_NOT_ACTIVE: 'CHARACTER_NOT_ACTIVE',
  PHONE_ACCESS_FAILED: 'PHONE_ACCESS_FAILED',
  CHARACTER_DISCORD_DISABLED: 'CHARACTER_DISCORD_DISABLED',
  CATEGORY_DISABLED: 'CATEGORY_DISABLED',
  DISCORD_DM_UNAVAILABLE: 'DISCORD_DM_UNAVAILABLE',
  PLAYER_OFFLINE_CANCELLED: 'PLAYER_OFFLINE_CANCELLED',
} as const;
