...
const STORE_APPS = [
  ...
  },
  {
    ...
    category: 'utilities' as const,
    permissions: ['location', 'network', 'notifications', 'storage', 'camera'] as const,
    tagline: 'Drive the Gulf economy.',
    longDescription: 'Complete vehicle marketplace with dealership management, buy/sell, financing, leasing, auctions, trade-ins, analytics, and full GULFOS ecosystem integration.',
    screenshots: ['🚗', '🏪', '💰'],
    featured: true,
    trending: true,
    editorsChoice: true,
  ...
  },
  {
    ...
    longDescription: 'Complete aviation ecosystem with aircraft marketplace, airports, hangars, fleet management, financing, leasing, auctions, and full GULFOS integration.',
    screenshots: ['✈️', '🛫', '💰'],
    featured: true,
    trending: true,
    editorsChoice: true,
  ...
  },
  {
    ...
    longDescription: 'Complete marine ecosystem with vessel marketplace, marinas, docks, ports, fleet management, financing, leasing, auctions, and full GULFOS integration.',
    screenshots: ['⚓', '🛥️', '💰'],
    featured: true,
    trending: true,
    editorsChoice: true,
  ...
  },
  {
    ...
    category: 'finance' as const,
    permissions: ['location', 'network', 'notifications', 'storage'] as const,
    tagline: 'Invest in the Gulf.',
    longDescription: 'The official GULFOS stock exchange. Trade stocks priced from the Economy Engine, manage portfolios, IPOs, dividends, market indexes, and real-time market data.',
    screenshots: ['📈', '💹', '🏦'],
    featured: true,
    trending: true,
    editorsChoice: true,
