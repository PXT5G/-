...
const STORE_APPS = [
  ...
  },
  {
    ...
    permissions: ['network', 'notifications', 'biometrics'] as const,
    tagline: 'Your connection, managed.',
    longDescription: 'Complete telecommunications system — SIM profiles, phone numbers, carrier management, call and SMS settings with full RBAC.',
    screenshots: ['📶', '📱', '🔒'],
    featured: true,
    trending: true,
    editorsChoice: true,
  ...
  },
  {
    ...
    icon: '👤',
    category: 'communication' as const,
    permissions: ['contacts', 'storage'] as const,
    tagline: 'Everyone you know, organized.',
    longDescription: 'Complete contact management with groups, favorites, emergency contacts, import/export, and full RBAC integration with Phone, SMS, and Messenger.',
    screenshots: ['👤', '👥', '⭐'],
    featured: true,
    trending: true,
    editorsChoice: true,
