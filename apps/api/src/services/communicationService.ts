...
async function assertCanSend(userId: string, conversationId: string, appId: string) {
  ...
  if (!allowed && appId !== 'com.gulfos.system' && appId !== 'com.gulfos.communication' && appId !== 'com.gulfos.chat' && appId !== 'com.gulfos.justice' && appId !== 'com.gulfos.ems' && appId !== 'com.gulfos.business' && appId !== 'com.gulfos.real-estate' && appId !== 'com.gulfos.vehicles' && appId !== 'com.gulfos.aviation' && appId !== 'com.gulfos.marine' && appId !== 'com.gulfos.economy-engine') {
