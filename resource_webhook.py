"""Universal webhook layer for cross-system resource-error integration."""
...
class ResourceErrorWebhookHandler:
    """Triggers GenericWebhook on SMS/captcha-style resource errors."""
